...
def main():
        ...
        def MLP(): #Primarily used for training either a new model or updating a previous model
            ...
            if load == 'y':
                ...
                mlp = MLPClassifier(hidden_layer_sizes=(5), activation='logistic', max_iter=1000, verbose=True, tol=0.000001) # number of hidden layers = 1 layer of 10 nodes
