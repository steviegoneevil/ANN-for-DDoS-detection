                                    ...
                                    if pkt.highest_layer != 'ARP':
                                        ...
                                        try:
                                            if ip.src not in allowed_IP:
                                                    ...
                                                    ipcat = 0
                                                    target = 0
                                            filewriter.writerow([pkt.highest_layer, transport_layer, ipcat, ip.dst, pkt[pkt.transport_layer].srcport, pkt[pkt.transport_layer].dstport,pkt.length, i/(time.time() - start_time), target ])
                                            print ("Time: ", time.time() - start_time)
                                            i += 1
                                        except AttributeError:
                                            if ip.src not in allowed_IP:
                                                    ...
                                                    ipcat = 0
                                                    target = 0
                                            filewriter.writerow([pkt.highest_layer, transport_layer, ipcat, ip.dst, 0, 0, pkt.length, i/(time.time() - start_time), target ])
                                            print ("Time: ", time.time() - start_time)
                                            i += 1
